          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm space-y-4">
                ...
                <a
                  href="mailto:holidayspravaas@gmail.com"
                  className="flex items-center gap-3 text-navy hover:text-cta transition-colors"
                >
                  <div className="w-9 h-9 rounded-full bg-surface flex items-center justify-center shrink-0">
                    <svg className="w-4 h-4 text-navy" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <p className="text-sm font-medium">holidayspravaas@gmail.com</p>
                  ...
                  <>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-cta hover:bg-cta-hover disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold py-3.5 rounded-full transition-colors text-sm"
                      >
